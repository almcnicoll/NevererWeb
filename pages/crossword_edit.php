...
<?php
    ...
    $form_edit_settings->addField('trim_left')->setValue(0)->setLabel('Trim left')->setType("number")->setColumn(2)->setDivClass('mb-3')->setClass('border-secondary')->setStylePreset('floating')->setStyle('max-width: 10em;')->setAdditionalAttributes(['min'=>1,'max'=>$crossword->cols])->setHelp("");
    $form_edit_settings->addField('trim_bottom')->setValue(0)->setLabel('Trim bottom')->setType("number")->setColumn(1)->setDivClass('mb-3')->setClass('border-secondary')->setStylePreset('floating')->setStyle('max-width: 10em;')->setAdditionalAttributes(['readonly'=>'readonly'])->setHelp("");
    $form_edit_settings->addField('trim_right')->setValue(0)->setLabel('Trim right')->setType("number")->setColumn(2)->setDivClass('mb-3')->setClass('border-secondary')->setStylePreset('floating')->setStyle('max-width: 10em;')->setAdditionalAttributes(['readonly'=>'readonly'])->setHelp("");
