...
<?php
    ...
    $form_edit_settings->addField('rows')->setValue($crossword->rows)->setLabel('Row count')->setType("number")->setDivClass('mb-3')->setClass('border-secondary')->setStylePreset('floating')->setStyle('max-width: 10em;')->setAdditionalAttributes(['min'=>1,'max'=>50])->setHelp("(will affect existing clues)");
    $form_edit_settings->addField('cols')->setValue($crossword->cols)->setLabel('Column count')->setType("number")->setDivClass('mb-3')->setClass('border-secondary')->setStylePreset('floating')->setStyle('max-width: 10em;')->setAdditionalAttributes(['min'=>1,'max'=>50])->setHelp("(will affect existing clues)");
    $form_edit_settings->addField('trim_top')->setValue(0)->setLabel('Trim top')->setType("number")->setDivClass('mb-3')->setClass('border-secondary')->setStylePreset('floating')->setStyle('max-width: 10em;')->setAdditionalAttributes(['min'=>1,'max'=>$crossword->rows])->setHelp("");
    $form_edit_settings->addField('trim_left')->setValue(0)->setLabel('Trim left')->setType("number")->setDivClass('mb-3')->setClass('border-secondary')->setStylePreset('floating')->setStyle('max-width: 10em;')->setAdditionalAttributes(['min'=>1,'max'=>$crossword->cols])->setHelp("");
    $form_edit_settings->addField('trim_bottom')->setValue(0)->setLabel('Trim bottom')->setType("number")->setDivClass('mb-3')->setClass('border-secondary')->setStylePreset('floating')->setStyle('max-width: 10em;')->setAdditionalAttributes(['readonly'=>'readonly'])->setHelp("");
    $form_edit_settings->addField('trim_right')->setValue(0)->setLabel('Trim right')->setType("number")->setDivClass('mb-3')->setClass('border-secondary')->setStylePreset('floating')->setStyle('max-width: 10em;')->setAdditionalAttributes(['readonly'=>'readonly'])->setHelp("");
