...
<?php
    ...
    $form_edit_settings->addField('trim_top')->setValue(0)->setLabel('Trim top')->setType("number")->setColumn(1)->setDivClass('mb-3')->setClass('border-secondary alters-trim')->setStylePreset('floating')->setStyle('max-width: 10em;')->setAdditionalAttributes(['min'=>1,'max'=>$crossword->rows])->setHelp("");
    $form_edit_settings->addField('trim_left')->setValue(0)->setLabel('Trim left')->setType("number")->setColumn(2)->setDivClass('mb-3')->setClass('border-secondary alters-trim')->setStylePreset('floating')->setStyle('max-width: 10em;')->setAdditionalAttributes(['min'=>1,'max'=>$crossword->cols])->setHelp("");
